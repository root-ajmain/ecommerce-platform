...
export const api = {
  products: {
    ...
    getBySlug: (slug: string) =>
      fetchApi<{ id: string; name: string; slug: string; shortDescription?: string; metaTitle?: string; metaDesc?: string; images?: Array<{ url: string }>; categories?: Array<{ category: { name: string; slug: string } }>; reviews?: unknown[]; rating: number; reviewCount: number }>(
        `/products/${slug}`,
